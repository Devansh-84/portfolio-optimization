...
# Cost function and portfolio optimization
...
def main():
    ...
    total_investment = st.number_input("Enter your investment amount (in INR):", min_value=1.0)
    ...
    if selected_stocks:
        st.write("Fetching stock data for the selected stocks...")
        ...
        target_return = 0.15 / 252  # Target daily return (15% annualized)
        ...
        st.write(f"Expected Portfolio Risk (Volatility): {portfolio_risk * 100:.2f}%")
